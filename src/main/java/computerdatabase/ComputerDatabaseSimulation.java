...
public class ComputerDatabaseSimulation extends Simulation {
    ...
    ChainBuilder delete =  exec(http("Home").delete("/"));

    ChainBuilder post =  exec(http("Home").post("/"));

    ChainBuilder put =  exec(http("Home").put("/"));

    ChainBuilder options =  exec(http("Home").options("/"));
